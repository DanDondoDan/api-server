...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api_server', '0013_auto_20190109_1730'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), max_digits=20)),
                ('transaction_id', models.CharField(help_text="The transaction processor's reference", max_length=255)),
                ('payment_method', models.CharField(help_text='The payment backend used to process the purchase', max_length=50)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='order',
            name='currency',
            field=models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, to='api_server.ExchangeRates'),
        ),
        migrations.AddField(
            model_name='order',
            name='customer',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='api_server.Customer'),
        ),
        migrations.AddField(
            model_name='order',
            name='text',
            field=models.TextField(default=None, help_text='info fir this order odj on the moment of purshase'),
        ),
        ...
        migrations.AddField(
            ...
            name='order',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api_server.Order'),
        ),
    ]
