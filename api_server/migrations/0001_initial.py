# Generated by Django 2.1.4 on 2018-12-28 12:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(blank=True, help_text='Parent unit.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='api_server.Unit', verbose_name='Parent unit')),
            ],
            options={
                'verbose_name': 'Unit',
        ...
        migrations.AddField(
            model_name='person',
            name='unit',
            field=mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api_server.Unit'),
        ),
        migrations.AddField(
            model_name='person',
            name='user',
