# Generated by Django 2.1.4 on 2018-12-28 14:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(blank=True, help_text='Parent unit.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='api_server.Department', verbose_name='Parent unit')),
            ],
            options={
                'verbose_name': 'Unit',
